...
const OFFRES_PAR_UNIVERS: Record<UniversOffre, string[]> = {
  ...
  INTERNET: [
    ...
    "Fibre 500M",
    "Fibre 1Go",
    "4G Office Flybox Prep",
    "Pack 4G Initial FLYBOX mini",
    "Pack 4G Initial TOZED V20",
    "Internet TopUp",
    "TDD/FDD 100K",
  ],
  ICT: [
    ...
    "Easy Office 59K",
    "Easy Office 109K",
    "Baas Flexible Backup 35K",
    "Baas Flexible Backup 65K",
    "MSSP",
    "EDR",
    "YouScribe 5K",
    "YouScribe 10K",
  ...
  FIXE: [
    "Voix Fixe Postpayé",
    "Voix Fixe Hybrid",
    "Voix Fixe Prépayé Basic 6 Pro",
    "Voix Fixe Prépayé Basic 12 Pro",
    "Fixe T0",
  ],
  AUTRES: ["Autre"],
};
